    ...
    public static void return_list_model(DefaultListModel<String> listmodel, ArrayList<String[]> order_history) {
        if (Constant.isAdmin()) {
            for (String[] order : order_history) {
                list_model_add_elementUseCase.add_element_to_list_model_admin(listmodel, order);
            }
        } else {
            for (String[] order : order_history) {
                list_model_add_elementUseCase.add_element_to_list_model_customer(listmodel, order);
            }
        }
